...
"""
If we hit enter run on this it will show successful execution but will not print anything.
But, here we are creating our website and that we can access through a server.
So, we will need to understand here that:
